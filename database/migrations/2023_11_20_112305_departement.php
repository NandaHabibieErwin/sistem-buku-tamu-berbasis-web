...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('departement', function (Blueprint $table) {
            ...
            $table->longText('desc_departement');
        });

        DB::table('departement')->insert([
            ['nama_departement' => 'Bidang Kesehatan Masyarakat Veteriner', 'desc_departement' => 'Lorem Ipsum'],
            ['nama_departement' => 'Bidang Produksi Peternakan', 'desc_departement' => 'Lorem Ipsum'],
            ...
            ['nama_departement' => 'Bidang Keuangan', 'desc_departement' => 'Lorem Ipsum'],
            ['nama_departement' => 'Bidang Kepegawaian Umum', 'desc_departement' => 'Lorem Ipsum'],
